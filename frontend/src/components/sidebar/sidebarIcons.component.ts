export function sidebarIcons({
  ...
  div.innerHTML = `
    <button data-open= data-id="${serverId}" class="relative cursor-pointer mb-4  pb-2 group" id="serverid-${serverId}" >
      <div
      ...
      >
        <img 
          src="${serverPicture ? "https://cdn.discordapp.com/embed/avatars/2.png" : serverPicture}" 
